...
investments, interest rates, etc. The program outputs a display of the data the
...
int main() {
    ...
    /* The while loops displays the menu and prompts the user for input regarding
     the menu choice. After the user gives input, the designated if-statement
     runs and if the input is not one of the options, the program outputs an
     error message and redisplays the menu until a valid choice is inputed.
    */
   // loop stops running after user inputs "D" to quit
    while(userInput != "D") {
        ...
        // This section calculates the monthly mortgage payment. It takes
        ...
        // This section calculates the value of an investment made now.
        // It takes into account the interest rate, number of years into
        // the future, and the present investment made.
        // Data entered should be a number (int or double) and will be 
        // converted to a double regardless. If the user enters a invalid
        // character, the input is ignored and the value is set to 0. 
        // It outputs a double.
        ...
        // This section calculates the value the user needs now to have a 
        ...
        // future and outputs the present amount needed.
        // Data entered should be a number (int or double) and will be 
        // converted to a double regardless. If the user enters a invalid
        // character, the input is ignored and the value is set to 0. 
        // It outputs a double.
